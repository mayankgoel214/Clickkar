...
import { CREATIVE_SCENE_PROMPT_GENERATOR } from '../prompts/ad-prompt-generator.js';
...
/**
 * Generate a BACKGROUND-ONLY scene prompt from the product analysis.
 *
 * The prompt describes an empty scene with NO product in it.
 * The real product cutout will be composited on top separately.
 * This ensures the product pixels are never regenerated by AI.
 */
export async function generateAdPrompt(
  ...
  let promptInput = CREATIVE_SCENE_PROMPT_GENERATOR + JSON.stringify(analysis, null, 2);
